...
public class Datesheet extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        url = addrs.substring(0,addrs.lastIndexOf("/")-3);
        sem+= getActivity().getIntent().getExtras().getString("sem");
        ...
        datesheetexpListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                Log.e(">>",ss1.get(childPosition)+" , "+ss2.get(childPosition));
    ...
    private void  getdata()
    {
        ...
        Firebase datesheetss1ref = new Firebase(getActivity().getString(R.string.dburl)+"/"+url+"/Datesheet/"+sem+"/sessional1/imgurl");
        ...
        Firebase datesheetss2ref = new Firebase(getActivity().getString(R.string.dburl)+"/"+url+"/Datesheet/"+sem+"/sessional2/imgurl");
        ...
        Firebase datesheetss3ref = new Firebase(getActivity().getString(R.string.dburl)+"/"+url+"/Datesheet/"+sem+"/sessional3/imgurl");
        datesheetss3ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ss3.clear();
                ss3.add(dataSnapshot.getValue().toString());
                Log.e(">>ss3",dataSnapshot.getRef().toString());
            }
        ...
        Firebase datesheetfinalref = new Firebase(getActivity().getString(R.string.dburl)+"/"+url+"/Datesheet/"+sem+"/final/imgurl");
