...
public class SendMailTask extends AsyncTask<Object, Integer,Objects> {
		...
		forgotpasschangedialog.setContentView(R.layout.frgtchangelayout);
		 ...
		 changepass.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					mref = new Firebase(sendMailActivity.getString(R.string.dburl)+dataloc+"/Password");
	...
	private void updateOTP(final Object... args) {
		checkref = new Firebase(sendMailActivity.getString(R.string.dburl)+ args[6] + "/" + args[7]);
		mref=checkref;
	...
	private void checkotp(final Object... args) {
		checkref = new Firebase(sendMailActivity.getString(R.string.dburl) + args[6] + "/" + args[7] + "/OTPCODE");
