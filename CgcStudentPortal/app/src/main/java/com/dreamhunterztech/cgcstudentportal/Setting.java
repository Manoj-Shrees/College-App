...
public class Setting extends AppCompatActivity {
    ...
    ImageButton changepassbtn,updateprobtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                display.setMessage("This is demo as we were working on it.we will provide this feature later on.\n\nThank you!!");
    ...
    private void getprofiledata()
    {
        ...
        Firebase userfirstnameref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Name");
        ...
        Firebase emailref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Email ID");
        ...
        Firebase mobnoref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Mobile Number");
        ...
        Firebase genderref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Gender");
        ...
        Firebase rollnoref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Rollno");
    ...
    private void updatepass()
    {
        ...
        if(oldpass.getText().toString().equals("") && newpass.getText().toString().equals("") && confirmpass.getText().toString().equals(""))
        {
            ...
            Firebase passref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Password");
   ...
   /* private void deleteprodata()
    {
        Firebase getrollnoref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs+"/Rollno");
        ...
        deleteprodialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            Firebase deletedataref = new Firebase(getApplicationContext().getString(R.string.dburl) + deleteref);
    ...
    {
        Firebase userref = new Firebase(getApplicationContext().getString(R.string.dburl)+addrs);
