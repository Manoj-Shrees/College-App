            ...
            public void onClick(View v) {
                ...
                btcse.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/CSE.pdf");
                        openpdf.putExtra("datatype","web");
                ...
                btece.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/ECE.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                ...
                btit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/IT.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                ...
                btme.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/ME.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                ...
                bt1styr.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/B.Tech%201st%20Year.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
            ...
            public void onClick(View v) {
                ...
                bca.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                                ...
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/BCA.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                    }
                });
                ...
                mca.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/MCA.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
        ...
        managementcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bba.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/BBA.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                ...
                mba.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/MBA.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
        ...
        hmanagementcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hmct.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/HMCT.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                athm.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/B.Sc%20ATHM.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
        ...
        pharmacard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bpharma.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/B.Pharmacy.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                mpharma.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/M.%20Pharm.%20(PHARMACEUTICS).pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
        ...
        biotechcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bscbiotech.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/B.Sc.Biotechnology.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                mscbiotech.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openpdf = new Intent(getContext(),PDFviewer.class);
                        openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Syllabus/M.Sc.Biotechnology.pdf");
                        openpdf.putExtra("datatype","web");
                        getContext().startActivity(openpdf);
                    }
                });
                ...
                opensubcodebtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        switch (subcodeselection.getSelectedItemPosition())
                        {
                            ...
                            case 1:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/B.tech%201st%20year.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 2:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/ME.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 3:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/ECE.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 4:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/CSE.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 5 :
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/IT.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 6:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/BBA.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 7:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/MBA.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 8:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/BCA.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 9:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/MCA.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 10:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/B.Pharmacy.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 11:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/M.%20Pharm.%20(PHARMACEUTICS).pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 12:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/B.Sc.Biotechnology.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 13:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/M.Sc.Biotechnology.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 14:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/HMCT.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
                            ...
                            case 15:
                                openpdf = new Intent(getContext(),PDFviewer.class);
                                openpdf.putExtra("pdf_url","https://cgcstudentportal.000webhostapp.com/Subjectcode/B.Sc.ATHM.pdf");
                                openpdf.putExtra("datatype","web");
                                getContext().startActivity(openpdf);
                                break;
