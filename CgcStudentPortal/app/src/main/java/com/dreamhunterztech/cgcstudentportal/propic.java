...
public class propic extends Fragment
{
    ...
    public void downloadproimage() {
        try {
            proimgref = new Firebase(getActivity().getString(R.string.dburl)+addrs+"/propic");
    ...
    {
        dataref= new Firebase(getActivity().getString(R.string.dburl)+addrs+"/propic");
